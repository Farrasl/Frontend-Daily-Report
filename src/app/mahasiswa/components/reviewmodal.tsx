...
const ReviewModal = ({ isOpen, onClose, taskIndex, tasks }: ReviewModalProps) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white rounded-lg w-full max-w-6xl p-6 relative shadow-lg">
        ...
        <div className="mb-4 flex items-center justify-between">
          ...
          <div className="bg-[#B7D896] text-gray-700 px-4 py-2 rounded-lg flex items-center gap-2">
            <p className="text-sm">Deskripsi agenda dapat diganti sebelum di acc Pembimbing Instansi.</p>
          </div>
        </div>
        ...
        <div className="grid gap-6">
          <div className="grid gap-4 md:grid-cols-2">
            <div>
              ...
              <div className="mb-6">
                <h3 className="text-sm text-gray-500 mb-1">DOSEN PEMBIMBING</h3>
                <p className="font-medium">Yelfi Vitriani, S.Kom., M.M.S.I.</p>
              </div>
              
              <div className="mb-6">
                <h3 className="text-sm text-gray-500 mb-1">PEMBIMBING INSTANSI</h3>
        ...
        {/* Agenda Description */}
        <div className="bg-[#9FD8E4] p-6 rounded-lg">
          ...
          <div className="mb-4 h-[300px] overflow-y-auto">
            ...
            <p className="font-semibold mb-2">{task.date} - 09.00 / 16.00</p>
            ...
            <p className="text-sm">
              ...
              aplikasi. Dengan beberapa perbaikan dan optimalisasi lebih lanjut,
              desain ini memiliki potensi untuk dikembangkan menjadi aplikasi
              yang efektif dan ramah pengguna. Lorem ipsum dolor sit amet
              consectetur adipisicing elit. Maxime quia dicta unde eveniet
              quisquam perspiciatis illum similique, eum consequuntur ad veniam
              ...
              Possimus rem saepe eos enim voluptatem? Eveniet incidunt,
              excepturi harum velit fugiat corrupti, hic adipisci doloribus,
              culpa neque facilis deleniti sint eius. Lorem ipsum dolor sit amet
              consectetur adipisicing elit. Corporis, voluptates? Ullam ipsa sit
              debitis, suscipit voluptatem iusto! Earum, voluptatibus. Beatae
              reiciendis provident magni recusandae consequatur libero
              consectetur consequuntur nulla velit.
            </p>
          </div>
          </div>
        </div>
