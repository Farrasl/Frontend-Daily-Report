...
export default function RootLayout({
  ...
  interface ProfilStudent {
    name: string;
    progress: number;
  }
  
  const profilStudent: ProfilStudent = { name: 'Abmi Sukma', progress: 75 };
  ...
  const menuItems = [
      ...
      icon: (
        <svg width="55" height="55" viewBox="0 0 55 55" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g clipPath="url(#clip0_514_801)">
            <path d="M27.4999 13.0396L38.9583 23.3521V41.25H34.3749V27.5H20.6249V41.25H16.0416V23.3521L27.4999 13.0396ZM27.4999 6.875L4.58325 27.5H11.4583V45.8333H25.2083V32.0833H29.7916V45.8333H43.5416V27.5H50.4166L27.4999 6.875Z" fill="#323232"/>
          </g>
          <defs>
    ...
    },
    {
      ...
      label: "Keluar",
      icon: (
        <svg width="55" height="55" viewBox="0 0 39 44" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g clipPath="url(#clip0_82_80)">
            <path d="M21.125 12.8333L23.4 15.4L19.175 20.1667H35.75V23.8333H19.175L23.4 28.6L21.125 31.1667L13 22L21.125 12.8333ZM6.5 34.8333H19.5V38.5H6.5C4.7125 38.5 3.25 36.85 3.25 34.8333V9.16667C3.25 7.15 4.7125 5.5 6.5 5.5H19.5V9.16667H6.5V34.8333Z" fill="#323232"/>
          </g>
          <defs>
  ...
  return (
    <main>
        ...
        <div className="lg:hidden w-full bg-[#9FD8E4] p-3 relative">
          ...
          >
            <svg 
              ...
              className={`transform transition-transform duration-300 ${isBurgerOpen ? 'rotate-90' : ''}`}
            >
              <path 
        ...
        {/* Desktop Sidebar - Rest of the code remains the same */}
        <div className="hidden lg:flex lg:flex-col gap-5 w-[80px] h-[96vh] ml-[22px] bg-[#9FD8E4] p-3 rounded-[20px] transition-all">
          <div className="nav mt-[175px] flex-1">
            <div className="menu">
          ...
          <div className="flex flex-col items-center relative">
            ...
            <div className="mt-3 mb-3">
              <div className="flex items-center justify-center w-[120px] h-[120px] lg:w-[150px] lg:h-[150px] rounded-full bg-[#9FD8E4] text-white font-bold text-4xl">
                {getInitials(profilStudent.name)}
              </div>
            </div>
            <h3 className="font-bold text-lg">{profilStudent.name}</h3>
